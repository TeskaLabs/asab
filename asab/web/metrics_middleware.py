...
def metrics_middleware_factory(metrics_service):
	...
	ResponseCounter = metrics_service.create_counter("web_requests", tags={"help": "Counts requests to asab endpoints.", "unit": "requests", "default-label": "RequestMetrics"})
	...
	async def metrics_middleware(request, handler):
		...
		print(ResponseCounter.rest_get())
