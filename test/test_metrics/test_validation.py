...
class TestValidation(MetricsTestCase):
	def test_validation_01(self):
		...
		self.assertEqual(
			...
			"".join(
				[
					"my\\,\\ count\\ er,host=mockedhost.com,appclass=mockappclass,foo=bar value1=0i,value2=0i 123450000000\n",
				]
			),
		)
	...
	def test_validation_02(self):
		...
		self.assertEqual(
			...
			"".join(
				[
					"mycounter,host=mockedhost.com,appclass=mockappclass,fo\\,\\ \\=\\ o=ba\\,\\ \\=\\ r value1=0i,value2=0i 123450000000\n",
				]
			),
		)
	...
	def test_validation_03(self):
		...
		self.assertEqual(
			...
			"".join(
				[
					"mycounter,host=mockedhost.com,appclass=mockappclass,foo=bar val\\,\\ ue1=0i,va\\,lue\\ 2=0i 123450000000\n",
				]
			),
		)
	...
	def test_validation_04(self):
		...
		self.assertEqual(
			...
			"".join(
				[
					'mycounter,host=mockedhost.com,appclass=mockappclass,foo=bar value1="te\\\\st\\\"1",value2="\\\"test\\\" 2" 123450000000\n',
				]
			),
		)
	...
	def test_validation_05(self):
		...
		self.assertEqual(
			influx_format,
			''.join([
				'test\\ histo\\,gram,host=mockedhost.com,appclass=mockappclass,fo\\,\\ \\=\\ o=ba\\,\\ \\=\\ r,le=10.0 value1=1i 123450000000\n',
				'test\\ histo\\,gram,host=mockedhost.com,appclass=mockappclass,fo\\,\\ \\=\\ o=ba\\,\\ \\=\\ r,le=100.0 value1=1i 123450000000\n',
				'test\\ histo\\,gram,host=mockedhost.com,appclass=mockappclass,fo\\,\\ \\=\\ o=ba\\,\\ \\=\\ r,le=inf value1=1i 123450000000\n',
				'test\\ histo\\,gram,host=mockedhost.com,appclass=mockappclass,fo\\,\\ \\=\\ o=ba\\,\\ \\=\\ r sum=5.0 123450000000\n',
				'test\\ histo\\,gram,host=mockedhost.com,appclass=mockappclass,fo\\,\\ \\=\\ o=ba\\,\\ \\=\\ r count=1i 123450000000\n',
			])
		)
