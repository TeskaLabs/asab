...
class TestHistogram(MetricsTestCase):
	...
	def test_histogram_01(self):
		...
		self.assertEqual(
			influx_format,
			''.join([
				'testhistogram,host=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id,foo=bar,le=10.0 value1=1i 153450000000\n',
				'testhistogram,host=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id,foo=bar,le=100.0 value1=1i 153450000000\n',
				'testhistogram,host=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id,foo=bar,le=inf value1=1i 153450000000\n',
				'testhistogram,host=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id,foo=bar sum=5.0 153450000000\n',
				'testhistogram,host=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id,foo=bar count=1i 153450000000\n',
			])
		)
