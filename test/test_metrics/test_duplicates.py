...
class TestDuplicates(MetricsTestCase):
	...
	def test_duplicates_01(self):
		Gauge1 = self.MetricsService.create_gauge("gauge1", self.MockApplication, init_values={"v1": 0})
		Gauge2 = self.MetricsService.create_gauge("gauge1", self.MockApplication, init_values={"v1": 0})
