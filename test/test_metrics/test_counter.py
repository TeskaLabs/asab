...
class TestCounter(MetricsTestCase):
	...
	def test_counter_01(self):
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,host=mockedhost.com,appclass=mockappclass,foo=bar value1=0i,value2=0i 123450000000\n",
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				...
				'mycounter{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value1"} 0\n',
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,host=mockedhost.com,appclass=mockappclass,foo=bar value1=1i,value2=0i 123450000000\n",
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				'# TYPE mycounter gauge\n',
				'mycounter{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value1"} 1\n',
				'mycounter{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value2"} 0',
			])
		)
	...
	def test_counter_03(self):
		...
		self.assertEqual(
			...
			''.join([
				...
				'mycounter_ages{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value1"} 0\n',
				'mycounter_ages{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value2"} 0',
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				...
				'# UNIT mycounter_ages ages\n',
				'# HELP mycounter_ages Help!\n',
				'mycounter_ages{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value1"} 1\n',
				'mycounter_ages{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value2"} 0',
			])
		)
	...
	def test_counter_04(self):
		...
		self.assertEqual(
			...
			''.join([
				...
				'# UNIT mycounter_ages ages\n',
				'# HELP mycounter_ages Help!\n',
				'mycounter_ages{host="mockedhost.com",appclass="mockappclass",name="value1"} 1',
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,host=mockedhost.com,appclass=mockappclass value1=1i 123450000000\n",
			])
		)
	...
	def test_counter_05(self):
		...
		self.assertEqual(
			...
			''.join([
				...
				'# UNIT mycounter_ages ages\n',
				'# HELP mycounter_ages Help!\n',
				'mycounter_ages_total{host="mockedhost.com",appclass="mockappclass",name="value1"} 1\n',
				'mycounter_ages_total{host="mockedhost.com",appclass="mockappclass",name="value2"} 2',
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,host=mockedhost.com,appclass=mockappclass value1=2i 123450000000\n",
			])
		)
	...
	def test_counter_06(self):
		...
		self.assertEqual(
			...
			''.join([
				...
				'# UNIT mycounter_ages ages\n',
				'# HELP mycounter_ages Help!\n',
				'mycounter_ages_total{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value1"} 0\n',
				'mycounter_ages_total{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value2"} 0',
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				...
				'# UNIT mycounter_ages ages\n',
				'# HELP mycounter_ages Help!\n',
				'mycounter_ages_total{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value1"} 1\n',
				'mycounter_ages_total{host="mockedhost.com",appclass="mockappclass",foo="bar",name="value2"} -2',
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,host=mockedhost.com,appclass=mockappclass,foo=bar value1=2i,value2=0i 123450000000\n",
			])
		)
	...
	def test_counter_07(self):
		...
		self.assertEqual(
			...
			''.join([
				...
				'# UNIT mycounter_ages ages\n',
				'# HELP mycounter_ages Help!\n',
				'mycounter_ages{host="mockedhost.com",appclass="mockappclass",name="value1"} 2.2',
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,host=mockedhost.com,appclass=mockappclass value1=2.2 123450000000\n",
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,host=mockedhost.com,appclass=mockappclass value2=t 123450000000\n",
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				'mycounter,host=mockedhost.com,appclass=mockappclass value3="nice_weather" 123450000000\n',
			])
		)
