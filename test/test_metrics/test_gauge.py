...
class TestGauge(MetricsTestCase):
	...
	def test_gauge_01(self):
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"testgauge,hostname=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id v1=1i 123450000000\n",
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				...
				'testgauge{hostname="mockedhost.com",appclass="mockappclass",instance_id="test/instance/id",name="v1"} 1',
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"testgauge,hostname=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id v1=2i,v2=4i 123450000000\n",
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				'# TYPE testgauge gauge\n',
				'# HELP testgauge This is a test Gauge.\n',
				'testgauge{hostname="mockedhost.com",appclass="mockappclass",instance_id="test/instance/id",name="v1"} 2\n',
				'testgauge{hostname="mockedhost.com",appclass="mockappclass",instance_id="test/instance/id",name="v2"} 4',
			])
		)
	...
	def test_gauge_04(self):
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"testgauge,hostname=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id v1=2i 123450000000\n",
			])
		)
