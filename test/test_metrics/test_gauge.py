...
class TestGauge(MetricsTestCase):
	...
	def test_gauge_01(self):
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"testgauge,host=mockedhost.com,appclass=mockappclass v1=1i 123450000000\n",
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				...
				'testgauge{host="mockedhost.com",appclass="mockappclass",name="v1"} 1',
			])
		)
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"testgauge,host=mockedhost.com,appclass=mockappclass v1=2i,v2=4i 123450000000\n",
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				'# TYPE testgauge gauge\n',
				'# HELP testgauge This is a test Gauge.\n',
				'testgauge{host="mockedhost.com",appclass="mockappclass",name="v1"} 2\n',
				'testgauge{host="mockedhost.com",appclass="mockappclass",name="v2"} 4',
			])
		)
	...
	def test_gauge_04(self):
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"testgauge,host=mockedhost.com,appclass=mockappclass v1=2i 123450000000\n",
			])
		)
