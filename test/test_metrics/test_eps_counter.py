...
class TestEPSCounter(MetricsTestCase):
	...
	def test_eps_counter_01(self):
		...
		self.assertEqual(
			influxdb_format,
			''.join([
				"mycounter,hostname=mockedhost.com,appclass=mockappclass,instance_id=test/instance/id,foo=bar value1={}i,value2=0i 153450000000\n".format(value),
			])
		)
		...
		self.assertEqual(
			...
			''.join([
				...
				'mycounter{hostname="mockedhost.com",appclass="mockappclass",instance_id="test/instance/id",foo="bar",name="value1"} ' + '{}\n'.format(value),
